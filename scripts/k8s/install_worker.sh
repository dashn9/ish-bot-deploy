...
wget -q --show-progress --https-only --timestamping \
    https://dl.k8s.io/${KUBE_LATEST}/bin/linux/arm64/kube-proxy \
    https://dl.k8s.io/${KUBE_LATEST}/bin/linux/arm64/kubelet \
    https://dl.k8s.io/release/${KUBE_LATEST}/bin/linux/arm64/kubectl \
    https://github.com/kubernetes-sigs/cri-tools/releases/download/v1.31.1/crictl-v1.31.1-linux-arm64.tar.gz \
    https://github.com/opencontainers/runc/releases/download/v1.1.14/runc.arm64 \
    https://github.com/containernetworking/plugins/releases/download/v1.5.1/cni-plugins-linux-arm64-v1.5.1.tgz \
    https://github.com/containerd/containerd/releases/download/v1.7.21/containerd-1.7.21-linux-arm64.tar.gz 
...
sudo tar -xvf containerd-1.7.21-linux-arm64.tar.gz -C containerd
